package itzhuo.common.constants;
...
public interface MsgCode {
    ...
    MCode FA041 = MSG("更新失败！当前组织或下属组织已绑定用户，无法切换父层");
    ...
    MCode LOG109 = LOG("租户登录失败，请用手机验证码登录");
    MCode LOG110 = LOG("数据库异常，请联系管理员处理");
